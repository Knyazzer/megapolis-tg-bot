...
const REQUIRED_COLUMNS = [
  ...
  ['people', 'chat_read_at', 'DATETIME NULL AFTER chat_mode_updated_at'],
  ['people', 'last_seen_at', 'DATETIME NULL AFTER chat_read_at'],
  ...
  ['events', 'guest_arrival_at', 'DATETIME NULL AFTER date_end'],
  ['events', 'online_start', 'DATETIME NULL AFTER guest_arrival_at'],
  ...
  ['events', 'postpromo_message', 'TEXT NULL AFTER photo_album_url'],
  ['events', 'postpromo_send_at', 'DATETIME NULL AFTER postpromo_message'],
  ['events', 'offline_1day_send_at', 'DATETIME NULL AFTER postpromo_send_at'],
  ['events', 'offline_2hours_send_at', 'DATETIME NULL AFTER offline_1day_send_at'],
  ['events', 'offline_started_send_at', 'DATETIME NULL AFTER offline_2hours_send_at'],
  ['events', 'online_15min_send_at', 'DATETIME NULL AFTER offline_started_send_at'],
  ['events', 'online_started_send_at', 'DATETIME NULL AFTER online_15min_send_at'],
  ['events', 'is_active', 'TINYINT(1) NOT NULL DEFAULT 1 AFTER online_started_send_at'],
